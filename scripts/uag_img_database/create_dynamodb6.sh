...
do
    ...
    aws dynamodb put-item \
        --table-name works \
        --item "{\"id\": {\"S\": \"$work_id\"}, \"title\": {\"S\": \"Sample Work $i\"}, \"title_image_url\": {\"S\": \"http://example.com/title_image_$i.jpg\"}, \"creator\": {\"S\": \"Sample Creator $i\"}, \"category\": {\"S\": \"Art\"}, \"subject\": {\"S\": \"Abstract\"}, \"language\": {\"S\": \"English\"}, \"created_at\": {\"S\": \"2024-07-08T00:00:00Z\"}, \"updated_at\": {\"S\": \"2024-07-08T00:00:00Z\"}, \"page_count\": {\"N\": \"100\"}, \"likes\": {\"N\": \"10\"}, \"downloads\": {\"N\": \"5\"}}" \
        --endpoint-url $ENDPOINT_URL
    ...
    do
        ...
        aws dynamodb put-item \
            --table-name images \
            --item "{\"id\": {\"S\": \"$img_id\"}, \"work_id\": {\"S\": \"$work_id\"}, \"s3_url\": {\"S\": \"http://example.com/image${i}_${j}.jpg\"}}" \
            --endpoint-url $ENDPOINT_URL
    done
done
...
do
    ...
    do
        aws dynamodb put-item \
            --table-name work_tags \
            --item "{\"work_id\": {\"S\": \"$work_id\"}, \"tag_id\": {\"S\": \"$j\"}}" \
            --endpoint-url $ENDPOINT_URL
    done
done