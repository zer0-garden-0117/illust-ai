...
openApiGenerate {
    ...
    inputSpec.set("$rootDir/../docs/openapi/v1/cfa-v1.yaml")
    outputDir.set("$rootDir")
    apiPackage.set("com.cfa.zer0.generated.endpoint")
    modelPackage.set("com.cfa.zer0.generated.model")
    configOptions.set(
        mapOf(
...
tasks.named("openApiGenerate") {
    ...
    // 生成前にclean
    doFirst {
        delete("$rootDir/src/main/kotlin/com/cfa/zer0/generated")
    }
    // 生成後に不要ファイル削除
    doLast {
        delete(
